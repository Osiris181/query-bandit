...
os.environ['LD_LIBRARY_PATH'] = (
    '/home/osiris181/query-bandit/ffmpeg-master-latest-linux64-gpl-shared/lib' + 
    os.pathsep + os.environ.get('LD_LIBRARY_PATH', '')
)
#windows
#os.add_dll_directory("/home/osiris181/query-bandit/ffmpeg-7.1.1-full_build-shared/bin")
